<template>
    ...
    <div class="theme-layout" id="scrollup">
        ...
        <div class="responsive-opensec">
          <div class="btn-extars">
            <a href="#" title="" class="post-job-btn"
              ><i class="la la-plus"></i>Post Jobs</a
            >
            <ul class="account-btns">
              ...
              <li class="signin-popup">
                <a title=""><i class="la la-external-link-square"></i> Login</a>
              </li>
            </ul>
          </div>
          <!-- Btn Extras -->
          ...
          <div class="responsivemenu">
            <ul>
              ...
              <li class="menu-item-has-children">
                ...
                <ul>
                  <li>
                    <a href="employer_list1.html" title=""> Employer List 1</a>
                  </li>
                  <li>
                    <a href="employer_list2.html" title="">Employer List 2</a>
                  </li>
                  <li>
                    <a href="employer_list3.html" title="">Employer List 3</a>
                  </li>
                  <li>
                    <a href="employer_list4.html" title="">Employer List 4</a>
                  </li>
                  <li>
                ...
                <ul>
                  ...
                  <li>
                    <a href="candidates_single.html" title=""
                      >Candidates Single 1</a
                    >
                  </li>
                  <li>
                    <a href="candidates_single2.html" title=""
                      >Candidates Single 2</a
                    >
                  </li>
                  <li class="menu-item-has-children">
          ...
          <div class="container">
            ...
            <div class="btn-extars">
              ...
              <ul class="account-btns">
                ...
                <li class="signin-popup">
                  <a title=""
                    ><i class="la la-external-link-square"></i> Login</a
                  >
                </li>
              </ul>
            </div>
              ...
              <ul>
                ...
                <li class="menu-item-has-children">
                  ...
                  <ul>
                    ...
                    <li><a href="faq.html" title="">FAQ's</a></li>
                    <li>
                      <a href="how_it_works.html" title="">How it works</a>
                    </li>
                    <li><a href="login.html" title="">Login</a></li>
                    <li><a href="pricing.html" title="">Pricing Plans</a></li>
                    <li><a href="register.html" title="">Register</a></li>
                    ...
                    <li>
                      ...
                      ><span
                        ...
                        <a
                          ...
                          class="__cf_email__"
                          data-cfemail="c6afa8a0a986aca9a4aeb3a8b2e8a5a9ab"
                          >[email&#160;protected]</a
                        ></span
                      >
                    </li>
      ...
      <footer>
                  ...
                  <div class="about_widget">
                    ...
                    <span
                      ><a
                        href="https://grandetest.com/cdn-cgi/l/email-protection"
                        class="__cf_email__"
                        data-cfemail="d2bbbcb4bd92b8bdb0baa7bca6fcb1bdbf"
                        >[email&#160;protected]</a
                      ></span
                    >
                    <div class="social">
        ...
        <div class="bottom-line">
          <span
            >© 2018 Jobhunt All rights reserved. Design by Creative Layers</span
          >
      ...
      <div class="account-popup">
        ...
        <form>
          ...
          <p class="remember-label">
            <input type="checkbox" name="cb" id="cb1" /><label for="cb1"
              >Remember me</label
            >
          </p>
  ...
  <!-- Mirrored from grandetest.com/theme/jobhunt-html/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Dec 2019 18:54:26 GMT -->
</template>
<script>
export default {
  name: "ContactUs"
